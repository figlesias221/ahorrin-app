...
<AffiliateCTA program="wise" title="Wise: la opción más barata para cobrar del exterior" cta="Crear cuenta en Wise">
Comisión de **0,4%–0,6%** con tipo de cambio real, contra 3%–5% de PayPal. Te da datos bancarios en USD, EUR y GBP para que tus clientes te paguen como si fueras local.
</AffiliateCTA>
