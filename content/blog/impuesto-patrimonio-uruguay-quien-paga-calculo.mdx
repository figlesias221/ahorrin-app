...
excerpt: 'Todo sobre el Impuesto al Patrimonio en Uruguay. Quién está obligado a pagar, cuál es el mínimo no imponible (~4 millones de UI), tasas por tramo, qué bienes cuentan y cuáles están exentos. Con tablas, ejemplos y cálculos reales.'
category: 'Impuestos'
date: '2026-04-13'
readTime: '14 min'
author:
