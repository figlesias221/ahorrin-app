...
export const metadata: Metadata = {
  ...
  description:
    'Importá extractos bancarios de Itaú Uruguay a Gasty. Categorización automática con IA, dashboard en tiempo real y reportes completos. Compatible con Mi Banco Digital Itaú.',
  keywords: [
    'itau uruguay',
    'itaú uruguay',
    'extracto itau',
    'mi banco digital itau',
    'itau extracto',
    'analizar extracto itau',
    'categorizar gastos itau',
  ],
  alternates: {
    canonical: 'https://www.gasty.app/itau',
  },
  openGraph: {
    title: 'Itaú Uruguay + Gasty - Gestión Financiera Inteligente',
    description:
      'Controlá tus gastos de Itaú Uruguay con Gasty. Importá extractos, categorización automática y análisis completo de finanzas.',
    url: 'https://www.gasty.app/itau',
  },
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold">Compatible con Itaú Uruguay</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Gestioná tus Finanzas de Itaú con Inteligencia Artificial
              </h1>

              <p className="text-xl sm:text-2xl text-white/90 mb-8 leading-relaxed">
                Importá extractos desde Mi Banco Digital y obtén categorización automática, gráficas interactivas y control total de tus gastos. Privado y seguro.
              </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border-2 border-white/20 shadow-2xl">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-bold text-lg">2. Sube a Gasty</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">1. Descargá desde Itaú</h3>
              <div className="space-y-3 text-muted-foreground">
                <p><strong className="text-foreground">Mi Banco Digital Itaú</strong>:</p>
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Reconoce formato Itaú Uruguay</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              Por Qué Clientes Itaú Eligen Gasty
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                No necesitás conectar tu cuenta Itaú. No pedimos credenciales. Solo subís el extracto descargado. Encriptación bancaria (AES-256).
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold mb-3">Multi-Producto Itaú</h3>
              <p className="text-muted-foreground">
                Cuenta corriente, caja de ahorro, tarjeta de crédito Itaú. Importá todos tus productos y analizalos juntos o por separado.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Usás otros bancos también? Gasty soporta BBVA, Scotia, BROU, Santander. Todas tus cuentas en un solo lugar.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <details className="bg-card border border-border rounded-xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ¿Tengo que dar mis claves de Itaú?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-muted-foreground mt-4">
                NO. Jamás pedimos tus credenciales de Itaú. Vos descargás el extracto manualmente desde Mi Banco Digital y lo subís a Gasty. No hay conexión directa con tu cuenta bancaria.
              </p>
            </details>

            <details className="bg-card border border-border rounded-xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ¿Funciona con tarjeta Itaú Mastercard?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-muted-foreground mt-4">
                Sí! Podés importar el resumen de tu tarjeta de crédito Itaú desde Mi Banco Digital. Gasty categoriza automáticamente todos tus gastos de tarjeta.
              </p>
            </details>

            <details className="bg-card border border-border rounded-xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ¿Qué hago si uso Itaú + otro banco?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-muted-foreground mt-4">
                Perfecto! Gasty soporta múltiples bancos. Importá extractos de Itaú, BBVA, Scotia, BROU, etc. en la misma cuenta. Podés ver todas tus finanzas unificadas o por banco separado.
              </p>
            </details>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-[#EC7000] to-[#C45800] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Miles de clientes Itaú ya usan Gasty. Súmate gratis.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'WebPage',
            name: 'Itaú Uruguay - Control de Gastos con Gasty',
            description:
              'Importá extractos de Itaú Uruguay a Gasty. Categorización automática con IA, gráficas y reportes completos.',
            url: 'https://www.gasty.app/itau',
          }),
        }}
      />
