...
export const metadata: Metadata = {
  title: 'Heritage Uruguay - Control Total de tus Finanzas | Ahorrin',
  description:
    'Importá extractos bancarios de Heritage Uruguay a Ahorrin. Categorización automática con IA, dashboard en tiempo real y reportes completos. Compatible con e-Heritage.',
  keywords: [
    'heritage uruguay',
    'banco republica uruguay',
    'extracto heritage',
    'e-heritage',
    'heritage extracto bancario',
    'analizar extracto heritage',
    'categorizar gastos heritage',
    'control gastos heritage',
    'finanzas heritage',
  ],
  alternates: {
    canonical: 'https://www.ahorrin.app/heritage',
  },
  openGraph: {
    title: 'Heritage Uruguay + Ahorrin - Gestión Financiera Inteligente',
    description:
      'Controlá tus gastos de Heritage Uruguay con Ahorrin. Importá extractos, categorización automática y análisis completo de finanzas.',
    url: 'https://www.ahorrin.app/heritage',
  },
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold">Compatible con Heritage Uruguay</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Gestioná tus Finanzas de Heritage con Inteligencia Artificial
              </h1>

              <p className="text-xl sm:text-2xl text-white/90 mb-8 leading-relaxed">
                Importá extractos desde e-Heritage y obtén categorización automática, gráficas interactivas y control total de tus gastos. Privado y seguro.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link
                  href="/signup"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white text-[#0066CC] rounded-lg font-bold text-lg hover:bg-white/90 transition-colors shadow-lg"
                >
                  Comenzar Gratis
                </Link>
                <Link
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <div className="space-y-3 text-muted-foreground">
                <p><strong className="text-foreground">e-Heritage Heritage</strong>:</p>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
              Por Qué Clientes Heritage Eligen Ahorrin
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Optimizado para el ecosistema Heritage Uruguay
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                No necesitás conectar tu cuenta Heritage. No pedimos credenciales. Solo subís el extracto descargado. Encriptación bancaria (AES-256).
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Cuenta corriente, caja de ahorro, tarjeta de crédito Heritage. Importá todos tus productos y analizalos juntos o por separado.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-6 hover:shadow-lg transition-shadow">
              ...
              <p className="text-muted-foreground">
                Usás otros bancos también? Ahorrin soporta BBVA, Scotia, Heritage, Santander. Todas tus cuentas en un solo lugar.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <details className="bg-card border border-border rounded-xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ¿Tengo que dar mis claves de Heritage?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-muted-foreground mt-4">
                NO. Jamás pedimos tus credenciales de Heritage. Vos descargás el extracto manualmente desde e-Heritage y lo subís a Ahorrin. No hay conexión directa con tu cuenta bancaria.
              </p>
            </details>

            <details className="bg-card border border-border rounded-xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ¿Funciona con tarjeta Heritage Mastercard?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-muted-foreground mt-4">
                Sí! Podés importar el resumen de tu tarjeta de crédito Heritage desde e-Heritage. Ahorrin categoriza automáticamente todos tus gastos de tarjeta.
              </p>
            </details>

            <details className="bg-card border border-border rounded-xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ¿Qué hago si uso Heritage + otro banco?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-muted-foreground mt-4">
                Perfecto! Ahorrin soporta múltiples bancos. Importá extractos de Heritage, BBVA, Scotia, Heritage, etc. en la misma cuenta. Podés ver todas tus finanzas unificadas o por banco separado.
              </p>
            </details>
      ...
      {/* CTA */}
      <section className="py-16 sm:py-24 bg-gradient-to-br from-[#0066CC] to-[#0044AA] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            Organizá tus Finanzas de Heritage en Minutos
          </h2>
          <p className="text-xl mb-8 text-white/90">
            Miles de clientes Heritage ya usan Ahorrin. Súmate gratis.
          </p>

          <Link
            href="/signup"
            className="inline-flex items-center justify-center px-10 py-5 bg-white text-[#0066CC] rounded-lg font-bold text-xl hover:bg-white/90 transition-colors shadow-xl"
          >
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'WebPage',
            name: 'Heritage Uruguay - Control de Gastos con Ahorrin',
            description:
              'Importá extractos de Heritage Uruguay a Ahorrin. Categorización automática con IA, gráficas y reportes completos.',
            url: 'https://www.ahorrin.app/heritage',
          }),
        }}
      />
