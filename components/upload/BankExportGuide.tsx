...
const BANK_GUIDES: BankGuide[] = [
  {
    ...
    tips: [
      ...
      'NO ofrece CSV directo, solo Excel - pero Ahorrin acepta archivos .xls/.xlsx sin problemas',
      'El formato de Itaú es automáticamente reconocido por Ahorrin',
  ...
  },
  {
    ...
    tips: [
      'Santander ofrece 3 formatos: Excel, .txt, y Multicash - elegí Excel o CSV para Ahorrin',
      ...
      'Ahorrin puede procesar múltiples archivos juntos',
  ...
  },
  {
    ...
    tips: [
      ...
      'Para períodos no cubiertos por estados, considerá la entrada manual en Ahorrin'
    ],
    limitations: [
  ...
  },
  {
    ...
    tips: [
      ...
      'El formato de exportación es estándar y compatible con Ahorrin',
  ...
  },
  {
    ...
    tips: [
      ...
      'El formato de exportación es compatible con Ahorrin',
  ...
  },
  {
    ...
    steps: [
      ...
      'Si no hay opción de exportación, considerá la entrada manual en Ahorrin'
    ],
    tips: [
      ...
      'Alternativamente, podés usar la entrada manual rápida en Ahorrin'
    ]
  }
];
              ...
              <div className="mt-4 pt-3 border-t border-border/50 space-y-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Usá la <strong>entrada manual rápida</strong> en Ahorrin para agregar tus transacciones de forma ágil y segura.
