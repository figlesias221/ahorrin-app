      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">¿Por qué existe Gasty?</h2>
          ...
          <div className="space-y-4 sm:space-y-5 text-sm sm:text-base leading-relaxed">
            ...
            <p className="text-foreground/90">
              Entonces hice Gasty. Una app que entiende nuestros bancos y comercios. Sin conectar tu cuenta. Simple y rápida. Y con poco trabajo tenés una visualización de datos muy amplia y clara.
            </p>
