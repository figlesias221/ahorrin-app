...
const testimonials = [
  ...
  },
  {
    ...
    location: 'Usuario verificado',
    rating: 5,
    text: 'Como freelancer con cuentas en BBVA y Scotia, necesitaba algo que me diera una vista unificada. Gasty lo hace perfecto. Subo los extractos y las reglas automáticas me salvan.',
  ...
  },
  {
    ...
    location: 'Usuario verificado',
    rating: 5,
    text: 'Probé varias apps pero todas querían acceso a mi banco. Gasty es la única que me deja mantener el control. Solo subo extractos CSV y listo. Me dio paz mental.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            Feedback real de uruguayos que ya están usando Gasty
          </p>
        </motion.div>
