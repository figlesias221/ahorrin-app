...
const testimonials = [
  {
    quote:
      'Ahorrin gives us the clarity that spreadsheets never could. I know exactly how every peso is working for me.',
    name: 'Jordan Kim',
        ...
        >
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-base ">
              From bank-grade security to advisor-level insights, thousands of teams rely on Ahorrin to keep their finances crystal clear and future-ready.
            </p>
