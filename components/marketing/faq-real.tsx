...
export function FAQReal() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Sí, puedes subir extractos históricos de tus bancos en formato PDF, Excel o CSV. Gasty los procesará y aplicará tus reglas automáticamente, permitiéndote ver tendencias desde el primer día.',
    },
    {
